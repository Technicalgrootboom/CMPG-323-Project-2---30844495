...
CREATE DATABASE [EcoPowerSolutions]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'EcoPowerSolutions', FILENAME = N'E:\Information Systems\Modules\Second Semester\CMPG 323\Project 2\Progess\Project-Latest\CMPG-323-Project-2---30844495\EcoPowerSolutionAPI\EcoPowerSolutions.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'EcoPowerSolutions_log', FILENAME = N'E:\Information Systems\Modules\Second Semester\CMPG 323\Project 2\Progess\Project-Latest\CMPG-323-Project-2---30844495\EcoPowerSolutionAPI\EcoPowerSolutions_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
